  ...
  return (
    <LayoutBaseDePagina flexDir={windowWidth <= 900 ? "column" : "row"}>
      <Container
        ...
        height=""
        width=""
        marginTop={windowWidth <= 900 ? 2 : 12}
        marginLeft={windowWidth <= 600 ? 0 : 1.5}
        marginRight={windowWidth <= 900 ? 0 : windowWidth / 200}
        flexDir="column"
        align={windowWidth <= 900 ? "center" : "start"}
      >
        <TTitlePrimary
          txtColor={theme.text.secondary}
          fontSize={windowWidth >= 900 ? windowWidth / 590 : windowWidth <= 600 ? 1.5 : 2}
        >
          Olá, eu sou
        </TTitlePrimary>
        <THeadingPrimary
          ...
          whiteSpace="nowrap"
          fontSize={windowWidth >= 900 ? windowWidth / 200 : windowWidth <= 600 ? 4.5 : 6}
        >
          Davi Alves
        </THeadingPrimary>
        <TTitlePrimary
