...
export const Rectangle = styled.span<IRectangleProps>`
  ...
  @media screen and (max-width: 600px) {
    &._1 {
      ...
      @keyframes rectangleAnimation_1 {
        0% {
          transform: translateY(2rem) translateX(-11rem) rotate(0deg);
        }
        25% {
          transform: translateY(0rem) translateX(-11rem) rotate(180deg);
        }
        50% {
          transform: translateY(0rem) translateX(-8rem) rotate(360deg);
        }
        75% {
          transform: translateY(2rem) translateX(-8rem) rotate(540deg);
        }
        100% {
          transform: translateY(2rem) translateX(-11rem) rotate(720deg);
        }
      }
    }
    &._2 {
    ...
    &._3 {
      ...
      @keyframes rectangleAnimation_3 {
        0% {
          transform: translateY(0rem) translateX(4rem) rotate(16deg);
        }
        50% {
          transform: translateY(-1rem) translateX(4rem) rotate(0deg);
        }
        100% {
          transform: translateY(0rem) translateX(4rem) rotate(16deg);
        }
    ...
    &._4 {
      ...
      @keyframes rectangleAnimation_4 {
        0% {
          transform: translateY(3rem) translateX(10rem) rotate(-16deg);
        }
        50% {
          transform: translateY(1rem) translateX(10rem) rotate(0deg);
        }
        100% {
          transform: translateY(3rem) translateX(10rem) rotate(-16deg);
        }
    ...
    &._5 {
      ...
      @keyframes rectangleAnimation_5 {
        0% {
          transform: translateY(7rem) translateX(8rem) rotate(0deg);
        }
        50% {
          transform: translateY(9rem) translateX(8rem) rotate(-25deg);
        }
        100% {
          transform: translateY(7rem) translateX(8rem) rotate(0deg);
        }
    ...
    &._6 {
      ...
      @keyframes rectangleAnimation_6 {
        0% {
          transform: translateY(8rem) translateX(5rem) rotate(-25deg);
        }
        50% {
          transform: translateY(10rem) translateX(5rem) rotate(10deg);
        }
        100% {
          transform: translateY(8rem) translateX(5rem) rotate(-25deg);
        }
    ...
    &._7 {
      ...
      @keyframes rectangleAnimation_7 {
        0% {
          transform: translateY(8rem) translateX(-8rem) rotate(0deg);
        }
        50% {
    ...
    &._8 {
      ...
      @keyframes rectangleAnimation_8 {
        ...
        50% {
          transform: translateY(12rem) translateX(-5rem) rotate(30deg);
        }
        100% {
          transform: translateY(10rem) translateX(-5rem) rotate(-10deg);
        }
    ...
    &._9 {
      ...
      @keyframes rectangleAnimation_9 {
        0% {
          transform: translateY(4rem) translateX(-14rem) rotate(0deg);
        }
        50% {
          transform: translateY(6rem) translateX(-14rem) rotate(180deg);
        }
        100% {
          transform: translateY(4rem) translateX(-14rem) rotate(360deg);
        }
      }
    }
    &._10 {
    ...
    &._13 {
      ...
      @keyframes rectangleAnimation_13 {
        0% {
          transform: translateY(0rem) translateX(7rem) rotate(30deg);
        }
        50% {
          transform: translateY(-4rem) translateX(7rem) rotate(210deg);
        }
        100% {
          transform: translateY(0rem) translateX(7rem) rotate(390deg);
        }
      }
    }
    &._14 {
